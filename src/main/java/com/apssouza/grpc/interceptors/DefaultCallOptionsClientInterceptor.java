...
/**
 * {@code DefaultCallOptionsClientInterceptor} applies specified gRPC {@code CallOptions} to every outbound request. By
 * default, {@code DefaultCallOptionsClientInterceptor} will not overwrite {@code CallOptions} already set on the
 * outbound request.
 *
...
public class DefaultCallOptionsClientInterceptor implements ClientInterceptor {
    ...
    private <T> CallOptions patchOption(
            CallOptions baseOptions, Function<CallOptions, T> getter, BiFunction<CallOptions, T, CallOptions> setter
    ) {
